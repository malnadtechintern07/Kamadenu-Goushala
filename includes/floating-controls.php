...
<div class="floating-control-panel">
    ...
    <div class="dropup">
        ...
        <ul class="dropdown-menu dropdown-menu-end floating-dropdown-menu">
            ...
            <li><a class="dropdown-item d-flex justify-content-between align-items-center" href="javascript:void(0)" onclick="setLanguage('hi')">हिन्दी <?php echo $current_lang === 'hi' ? '<i class="fas fa-check text-success ms-2"></i>' : ''; ?></a></li>
        </ul>
    </div>
