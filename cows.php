...
<section class="py-5">
    <div class="container">
        ...
        <form method="GET" action="/Kamadenu/cows.php" class="kamadenu-card p-4 mb-4">
            <div class="row g-3">
                <div class="col-md-4">
                    <label class="form-label font-ui small fw-bold">Search Cow</label>
                ...
                <div class="col-md-3">
                    <label class="form-label font-ui small fw-bold">Filter Breed</label>
                ...
                <div class="col-md-3">
                    ...
                    <select name="status" class="form-select">
                        ...
                        <option value="Available" <?php echo $status === 'Available' ? 'selected' : ''; ?>>Available for Adoption</option>
                        <option value="Sponsored" <?php echo $status === 'Sponsored' ? 'selected' : ''; ?>>Sponsored</option>
                    </select>
                </div>

                <div class="col-md-2 d-flex align-items-end">
                    <button type="submit" class="btn btn-kamadenu-primary w-100 font-ui fw-semibold"><i class="fas fa-filter me-1"></i> Apply</button>
                </div>
            </div>
        </form>
                    ...
                    <div class="col-md-4">
                        <div class="kamadenu-card h-100 hover-glow">
                            <div class="position-relative">
                                <img src="<?php echo img_url($cow['photo']); ?>" class="cow-card-img" alt="<?php echo e($cow['name']); ?>" onerror="this.src='https://images.unsplash.com/photo-1546445317-29f4545f9d52?auto=format&fit=crop&w=600&q=80'">
                            ...
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <h3 class="font-heading fs-4 mb-0"><?php echo e($cow['name']); ?></h3>
                                    <span class="badge bg-warning-subtle text-dark border border-warning"><?php echo e($cow['breed']); ?></span>
                                </div>
                                <p class="text-muted small mb-3"><?php echo e(mb_strimwidth($cow['rescue_story'], 0, 100, '...')); ?></p>
                                ...
                                <div class="d-flex justify-content-between align-items-center pt-2 border-top">
                                    <div>
                                        <small class="text-muted d-block">Monthly Care</small>
