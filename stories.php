            ...
            <?php foreach ($stories as $st): ?>
                <div class="col-md-6">
                    <div class="kamadenu-card h-100 p-4">
                        ...
                        <h3 class="font-heading fs-4 mb-2"><?php echo e($st['title']); ?></h3>
                        <p class="text-muted small mb-3"><?php echo e($st['summary']); ?></p>
                        <div class="lh-relaxed text-secondary mb-4"><?php echo $st['content']; ?></div>
