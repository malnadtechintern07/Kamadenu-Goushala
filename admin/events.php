...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/Kamadhenu-goushala/admin/event-add.php" class="btn btn-kamadenu-primary font-ui fw-bold"><i class="fas fa-plus me-1"></i> Add New Event</a>
</div>
            ...
            <tbody>
                <?php foreach ($events as $ev): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/Kamadhenu-goushala/admin/event-edit.php?id=<?php echo $ev['id']; ?>" class="btn btn-sm btn-outline-warning font-ui fw-bold"><i class="fas fa-edit me-1"></i> Edit & Update Photo</a>
