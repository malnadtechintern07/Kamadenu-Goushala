...
<div class="d-flex">
    ...
    <div class="admin-sidebar-nav p-3 shadow-lg">
        ...
        <div class="nav flex-column font-ui small gap-1">
            ...
            <a href="/Kamadenu/admin/feed.php" class="nav-link <?php echo is_admin_active('feed.php', $current_page); ?>"><i class="fas fa-cookie-bite"></i> <span>Feed Cow Manager</span></a>
            ...
            <a href="/Kamadenu/admin/settings.php#settings-group-payment" class="nav-link"><i class="fas fa-qrcode"></i> <span>Donate &amp; QR Settings</span></a>
            ...
            <a href="/Kamadenu/admin/stories.php" class="nav-link <?php echo is_admin_active('stories.php', $current_page); ?>"><i class="fas fa-newspaper"></i> <span>News &amp; Updates</span></a>
            ...
            <a href="/Kamadenu/admin/gallery.php" class="nav-link <?php echo is_admin_active('gallery.php', $current_page); ?>"><i class="fas fa-images"></i> <span>Photo Gallery</span></a>
            ...
            <a href="/Kamadenu/admin/button-settings.php" class="nav-link <?php echo is_admin_active('button-settings.php', $current_page); ?>"><i class="fas fa-paint-brush text-warning"></i> <span>Button Customizer</span></a>
            ...
            <div class="d-flex align-items-center gap-3 mt-3 mt-md-0">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 mt-2">
                        ...
                        <li><a class="dropdown-item" href="/Kamadenu/admin/settings.php"><i class="fas fa-user-cog me-2 text-primary"></i> Account Settings</a></li>
                        <li><a class="dropdown-item" href="/Kamadenu/index.php" target="_blank"><i class="fas fa-external-link-alt me-2 text-info"></i> View Public Site</a></li>
                        <li><hr class="dropdown-divider border-secondary border-opacity-25 my-2"></li>
