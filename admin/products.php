...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/Kamadhenu-goushala/admin/product-add.php" class="btn btn-kamadenu-primary font-ui fw-bold"><i class="fas fa-plus me-1"></i> Add New Product</a>
</div>
        ...
        <table class="table table-hover align-middle">
            ...
            <tbody>
                <?php foreach ($products as $p): ?>
                    <tr>
                         <td><img src="/Kamadhenu-goushala/<?php echo e($p['image']); ?>" class="rounded" style="width: 50px; height: 50px; object-fit: cover; flex-shrink: 0;" onerror="this.src='https://images.unsplash.com/photo-1589927986089-35812388d1f4?auto=format&fit=crop&w=100&q=80'"></td>
                        ...
                        <td>
                            <a href="/Kamadhenu-goushala/admin/product-edit.php?id=<?php echo $p['id']; ?>" class="btn btn-sm btn-outline-warning font-ui fw-bold"><i class="fas fa-edit me-1"></i> Edit</a>
